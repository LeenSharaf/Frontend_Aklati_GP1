...
class _ShopState extends State<Shop> {
  ...
  getData() async {
    var url = 'http://192.168.1.109/connect/getdata.php';
                        ...
                        InkWell(
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => Itm(
                                      shopdata: data(
                                          name: display_List[index]['item_name'],
                                          Image: display_List[index]['item_img'],
                                          desc: display_List[index]['item_desc'],
                                          price: display_List[index]['item_price'], 
                                          namepage: display_List[index]['item_page'], 
